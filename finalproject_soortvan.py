...
def dialog_tagger(sentences_tagged):
	active_dialog = 0
	for sentence in sentences_tagged:
		if sentence[0] == "C":
			active_dialog = 1
			character_name = sentence[1]
		if sentence[0] == "D" and active_dialog == 1:
			sentences_tagged[sentence].append(character_name)
		if sentence[0] != "D" and active_dialog == 1:
			active_dialog = 0
...
def main(argv):
	...
	sentences_tagged_3 = dialog_tagger(sentsences_tagged_2)
